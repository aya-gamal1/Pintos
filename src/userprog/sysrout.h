...
the child process successfully loaded its executable. You must use appropriate
...
its parent ever waits for it or not, and regardless of whether the child exits before or after its parent.
